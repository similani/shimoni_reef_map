...
pct_pattern <- c("circle", "circle", "stripe", "crosshatch", "")
pct_angle <- c(0,0,0,0,0)
pct_fill <- c('#dddddd')
pct_spacing <- c(0.07,0.03,0.04,0.03, 0.3)
pct_density <- c(0.4, 0.4,0.3,0.3, 0.3)
pct_pattern_fill <- c('red', 'orange', 'blue', 'green', 'white')
...
ggplot(data = data.1, mapping = aes(x="", y=cover)) +
    geom_bar_pattern(
      ...
      size                 = 1,
      pattern              = pct_pattern,
      pattern_angle        = pct_angle,
      fill                 = pct_fill,
      pattern_colour       = 'black',
      pattern_fill         = 'black',
      pattern_aspect_ratio = 1,
      pattern_density      = pct_density,
      pattern_spacing      = pct_spacing
   )+
